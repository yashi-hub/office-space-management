  ...
  <div class="welcome">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="content">
            <h2>Welcome to Query Submission</h2>
            </div>
        </div>
      </div>
    </div>
...
<tr>
  <th style="color:#FFF; font-family:'MS Serif', 'New York', serif;">Enrollment No</th>
    ...
    <input readonly value="<?php echo $e1; ?>" type="text" name="t9" required/></td>
    </tr>
  ...
  <td> 
    <label for="t1"></label>
    <input placeholder="Enter a valid email" type="email" name="t1" pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$" required/>
  </td></tr>
  ...
  <td>
    <label for="t5"></label>
    <input placeholder="Enter a valid 10 digit no." type="text" name="t5" pattern="[6-9]{1}[0-9]{9}" required/>
  </td></tr>
    <tr><th style="color:#FFF; font-family:'Comic Sans MS', cursive;">query</th><td><textarea rows="4" cols="50" name="t3">
</textarea></td></tr>        
  <tr>
  <th></th>
  <td style="color:#999;">
    <input style="color:#000;" type="submit" name="b1" id="b1" value="Submit Query" />  </td></tr>
</td>
</form>
</form>
