  ...
  <div class="welcome">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="content">
            <h2>Here are Feedback of employees</h2>
              	<?php 
$cn=mysqli_connect("localhost","root","","globalshala");
if(!$cn)
{
...
if($n>0)
{
	...
	while($rw=mysqli_fetch_array($result))
	{
        ...
        <p style="font-size:24px; font-family:'Times New Roman', Times, serif">
            ...
            Ambience : <?php echo $b; ?> Pointers<br/>
            Work Environment : <?php echo $c; ?> Pointers<br/>
            Food Court : <?php echo $d; ?> Pointers<br/>
            Resources : <?php echo $e; ?> Pointers<br/>
            Facilities : <?php echo $f; ?> Pointers<br/>
