...
<section id="contents">
  ...
  <div class="welcome">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="content">
            <h2>Welcome to the registration of new employee</h2>
            </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12">
          <div class="content">
            <h2>New employee details</h2>
  			...
  			<form id="form1" name="form1" method="post" action="addemployee1.php">
  ...
  <tr><th style="color:#FFF; font-family:'Comic Sans MS', cursive;">To Do list</th>
  <td> 
    <label for="t3"></label>
  ...
  <tr><th style="color:#FFF; font-family:'Comic Sans MS', cursive;">password</th>
  <td>
  <label for="t7"></label>
  ...
  <th></th>
  <td style="color:#999;">
    <input style="color:#000;" type="submit" name="b1" id="b1" value="Register" />
  </td></tr>
</form>
</div>
        </div>
