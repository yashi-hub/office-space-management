...
var w = dotty.width = window.innerWidth,
    ...
    opts = {
      ...
      colors: [ 'rgba(222,53,74,alp)', 'rgba(95,47,146,alp)', 'rgba(238,219,69,alp)' ], // Colors for the dots
      
      addedAlpha: 20,
      strokeColor: 'rgb(31,54,100)', // Color for the dots's sides
...
function loop(){
  ...
  ctx.shadowBlur = 0;
  ctx.fillStyle = 'rgba(9,11,24,alp)'.replace( 'alp', opts.repaintAlpha ); // Color for the background
