...
<?php
 ...
 if(isset($_POST["b1"]))
 {
	...
	$q1="insert into feedback (enrollmentno,name,branch,contact,employee,details) 
	values('$enrollmentno','$name','$branch','$contact','$employee','$details')";
...
?>
    ...
    <a href="adminhome.php" id="contBtn">Continue</a><br/>
 ...
 ?>
   <h3><a href="adminhome.php">Form Fill</a></h3>
